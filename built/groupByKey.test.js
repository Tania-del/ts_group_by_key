...
const students_json_1 = require("./students.json");
const books_json_1 = require("./books.json");
...
describe('Function "groupByKey"', () => {
    ...
    test('should group students by "age"', () => {
        const groupedData = groupByKey(students_json_1.default, 'age');
    ...
    test('should group students by "surname"', () => {
        const groupedData = groupByKey(students_json_1.default, 'surname');
        expect(Object.keys(groupedData))
            .toEqual([
            'Dorsey',
            'Branscome',
    ...
    test('should group books by year', () => {
        expect(groupByKey(books_json_1.default, 'year')).toEqual({
            1818: [{
    ...
    test('should group books by language', () => {
        expect(groupByKey(books_json_1.default, 'language')).toEqual({
            Japanese: [{
                    author: 'Yasunari Kawabata',
                    country: 'Japan',
                    imageLink: 'images/the-sound-of-the-mountain.jpg',
